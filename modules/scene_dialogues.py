...
p('All of a sudden, your hazard suit warns you a spike of radiation', 5)
p('The asteroid is going to explode',3)
p('You call for extraction and are told to fend off the now alerted uncured until they can resue you.', 7)
